...
const STRINGS = {
  ...
  subtitle: "Public jobs board for EVE Online — sortable and filterable, New Eden-wide",
  subtitle_exordium: "Public jobs board for Exordium, the new rookie starter region — connects to New Eden only via Manifest → Yulai, and once you leave there's no way back, so it gets its own board.",
  nav_new_eden: "New Eden",
  nav_exordium: "Exordium",
  nav_faq: "FAQ",
  nav_legal: "Legal",
  refresh: "Refresh",
  loading: "Loading jobs from ESI ...",
  loading_page: "Loading jobs from ESI ... (page {n}, {count} so far)",
  loading_capped: "Safety cap reached — {count} jobs loaded, more may be active.",
